...
async def lifespan(app: FastAPI):
    # Startup:
    cliend = AsyncIOMotorClient(MONGODB_URI)
    database = cliend.get_default_database()
...
async def created_todo_list(new_list:NewList) -> NewListResponse:
...
@app.delete("/api/lists/{list_id}/items/{items_id}")
